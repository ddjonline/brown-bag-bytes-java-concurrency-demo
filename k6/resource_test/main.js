...
export const options = {
  ...
  thresholds: {
    'http_req_failed{request_type:testLookup}': ['rate<0.01'], // http errors should be less than 1% for testLookup
    'http_req_blocked{request_type:testLookup}': ['p(95)<500'], // 95 percentile of the requests must not be blocked more than 0.5 seconds
    'http_req_waiting{request_type:testLookup}': ['p(95)<500'], // 95 percentile of the requests must not be waiting more than 0.5 seconds
    'http_req_duration{request_type:testLookup}': ['p(95)<10000'], // 95 percentile of requests must complete below 10s for testLookup
  },
  scenarios: {
